...
const Projects = () => {
  const projects = [
    {
      title: "Nexus GTA VI Store",
      description: "Loja virtual temática inspirada em GTA VI, criada para apresentar produtos em uma experiência visual imersiva e responsiva, com navegação moderna e identidade inspirada em Vice City.",
    ...
    {
      title: "BarberOS",
      description: "Sistema profissional de gestão e agendamento para barbearias, com controle de equipe, serviços, clientes, agenda e indicadores financeiros em uma interface responsiva.",
